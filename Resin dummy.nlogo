...
<experiments>
  <experiment name="experiment" repetitions="2" runMetricsEveryStep="false">
    ...
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>mean [mean-individual-internal-consistency] of people</metric>
    ...
    <steppedValueSet variable="#levels" first="2" step="1" last="7"/>
    ...
    <steppedValueSet variable="#items" first="3" step="1" last="10"/>
